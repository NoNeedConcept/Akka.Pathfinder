...
public abstract record DirectionCostRequest(int PointId, uint Value, Directions Direction, ChangeMethod ChangeMethod)
    : CostRequest(PointId, Value, ChangeMethod);

public record IncreaseDirectionCostRequest(int PointId, uint Value, Directions Direction)
    : DirectionCostRequest(PointId, Value, Direction, ChangeMethod.Increase);

public record DecreaseDirectionCostRequest(int PointId, uint Value, Directions Direction)
