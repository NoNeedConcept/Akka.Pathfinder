...
public record FindPathRequest(Guid PathfinderId, Guid PathId, int NextPointId, int TargetPointId, IReadOnlyList<PathPoint> Directions, SortedSet<Guid> SubPathIds) : PointRequest(NextPointId);