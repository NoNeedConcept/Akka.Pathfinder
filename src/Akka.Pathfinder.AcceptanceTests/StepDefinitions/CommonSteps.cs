...
{
    public static Direction To(this DemoLayout.Direction value)
        => value switch
        {
            DemoLayout.Direction.None => Direction.None,
            DemoLayout.Direction.Top => Direction.Top,
            DemoLayout.Direction.Bottom => Direction.Bottom,
            DemoLayout.Direction.Left => Direction.Left,
            DemoLayout.Direction.Right => Direction.Right,
            DemoLayout.Direction.Front => Direction.Front,
            DemoLayout.Direction.Back => Direction.Back,
            _ => Direction.None
        };
}
...
public class CommonSteps
{
    ...
    public async Task GivenMapIs(int mapId)
    {
        ...
        var result = await mapManagerClient.LoadAsync(new MapRequest { MapId = mapToLoad.Id.ToString() },
