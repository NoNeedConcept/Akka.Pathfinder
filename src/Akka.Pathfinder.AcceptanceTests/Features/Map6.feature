Feature: Map6
 256*256*1 Points map... basic function test for pathfinder
    ...
    Scenario: Find long Path on Map 6
        ...
        Then the path for PathfinderId e39cb9e2-7ab1-4e71-a603-2869e99939bb should cost 33264
    ...
    Scenario: Find multiple long Paths on Map 6
        ...
        Then the path for PathfinderId fe022be3-ca51-4d00-899d-e32da084899f should cost 40194
        Then the path for PathfinderId eac8a4fe-4b83-4f51-9f20-c8c8aae96f1d should cost 34524